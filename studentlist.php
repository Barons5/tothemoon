...
<body>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="studentedit.php?stu_id=<?php echo $row['stu_id']; ?>" class="btn btn-warning" >แก้ไข</a></td>
      <td><a href="studentdel.php?stu_id=<?php echo $row['stu_id']; ?>"  class="btn btn-danger" >ลบ</a></td>
    </tr>
   <?php
    }
?>
